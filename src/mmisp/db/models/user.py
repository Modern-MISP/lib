...
class User(Base):
    ...
    totp: Mapped[str | None] = mapped_column(String(255), nullable=True)
    hotp_counter: Mapped[int | None] = mapped_column(Integer, nullable=True)
    last_pw_change: Mapped[int | None] = mapped_column(BigInteger, nullable=True)
